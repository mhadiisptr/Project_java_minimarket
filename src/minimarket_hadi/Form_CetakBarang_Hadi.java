 ...
 * @author admin
 */
public class Form_CetakBarang_Hadi extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Form_CetakBarang_Hadi
     */
    public Form_CetakBarang_Hadi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CETAK LAPORAN BARANG TO PDF");
        ...
        jLabel10.setBounds(0, 300, 210, 48);
        ...
        setSize(new java.awt.Dimension(421, 402));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     try {
           ...
           jasperReport = JasperCompileManager.compileReport("src/Report/cetakbarang.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_CetakBarang_Hadi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_CetakBarang_Hadi().setVisible(true);
            }
        });
    }
