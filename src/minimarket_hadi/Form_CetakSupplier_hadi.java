 ...
 * @author admin
 */
public class Form_CetakSupplier_hadi extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Form_CetakSupplier_hadi
     */
    public Form_CetakSupplier_hadi() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CETAK LAPORAN SUPPLIER TO PDF");
        ...
        setSize(new java.awt.Dimension(433, 380));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     try {
           ...
           jasperReport = JasperCompileManager.compileReport("src/Report/cetaksupplier.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_CetakSupplier_hadi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_CetakSupplier_hadi().setVisible(true);
            }
        });
    }
